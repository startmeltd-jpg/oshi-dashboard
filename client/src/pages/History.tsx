...
const kpiData = [
  ...
  { date: '2026-03-10 記録係#83', users: 23409, nations: 117, youtube: 13445, verified: 12467, points: 32471355, note: 'Supabase677件確認（Gemini分析: status=WARNING・high比率14/30・アラート1件（OSHI Jr Bot絊急修復完了・今後の安定稼働に注意が必要）・記録係タスク定期実行継続中・収益化戦略立案中）・本日+421件（過去最大継続更新中）・記録係#1～#83連続完了' },
];
...
const milestones = [
  ...
  { date: '2026-03-10', label: '⚠️ 記録係タスク #1～#83 連続完了・Supabase677件確認・Gemini分析status:WARNING・high比率14/30・アラート1件（OSHI Jr Bot絊急修復完了・今後の安定稼働に注意）・本日+421件（過去最大継続更新中）', level: 'high' },
];
...
const todayAchievements = [
  ...
  { icon: '⚠️', title: '記録係タスク #1～#83 連続完了！', detail: 'Supabase677件確認（Gemini分析: status=WARNING・high比率14/30・アラート1件（OSHI Jr Bot絊急修復完了・今後の安定稼働に注意が必要）。記録係タスク定期実行継続中・収益化戦略立案中・3LLM並列分析実行中・Mac Mini 2台体制確立。本日+421件・過去最大継続更新中）。記録係#1～#83連続完了。' },
];
